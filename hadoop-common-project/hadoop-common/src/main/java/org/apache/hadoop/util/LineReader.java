...
public class LineReader implements Closeable {
  private static final int DEFAULT_BUFFER_SIZE = 64 * 1024;// liping:64k
  ...
  throws IOException {
    ...
    do {
        int startPosn = bufferPosn; //starting from where we left off the last time   bufferPosn这个类成员变量记录着读取buffer的具体位置
